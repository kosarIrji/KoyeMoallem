    ...
    >
      ...
      {windowHeight < 500 ? (
        ...
        >
          ...
          محله کوی معلم در بخش مرکزی‌ـ‌غربی شهر بجنورد قرار دارد. این محله از شمال با میدان توحید و بلوار شهدا، از شرق با خیابان صیاد شیرازی، از جنوب با چهارراه صیاد شیرازی، خیابان طالقانی غربی و میدان قائم، و از غرب با بلوار جانباز هم‌جوار است. همچنین با محلات ارتش، شیرآب و مصلی مجاورت دارد. موقعیت آن، ارتباط مؤثر با بخش‌های مرکزی و غربی شهر را فراهم کرده است.
          </p>
        </motion.div>
      ) : (
        ""
