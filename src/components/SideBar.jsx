  ...
  return (
    <>
      ...
      <div className="md:hidden fixed top-4 right-4 z-[1001]">
        <button
          onClick={toggleMenu}
          className="p-4 rounded-full shadow-lg border bg-[var(--box)]"
        >
              ...
              <li key={item.id}>
                {item.external ? (
                  <a
                    ...
                    className="flex flex-row-reverse items-center justify-end gap-2 text-right font-bold text-white hover:text-[var(--text)] hover:bg-gray-100 rounded-lg px-3 py-2 transition-all cursor-pointer"
                  >
                  ...
                  <ScrollLink
                    ...
                    className="flex flex-row-reverse items-center justify-end gap-2 text-right text-white hover:text-[var(--text)] hover:bg-gray-100 rounded-lg px-3 py-2 transition-all cursor-pointer"
                  >
                    <span className="text-2xl font-medium">{item.label}</span>
                    <span>{item.icon}</span>
                  </ScrollLink>
